...
<body id="top">
                ...
                <form name="volunteerForm" id="volunteerForm" class="volunteerForm" method="post" action="" autocomplete="off">
                    <fieldset>
                        ...
                        <div class="form-field">
                            <input name="name" id="cName" class="h-full-width h-remove-bottom" placeholder="Your Name" type="text">
                        </div>

                        <div class="form-field">
                            <input name="email" id="cEmail" class="h-full-width h-remove-bottom" placeholder="Your Email" type="email">
                        </div>

                        <div class="form-field">
                            <input name="phone" id="cPhone" class="h-full-width h-remove-bottom" placeholder="Mobile Number" type="number">
                        </div>

                        <br>
                        <div class="form-field">
                            <label for="cMinistry">Courses we offer</label>
                            <div class="ss-custom-select">
                                <select class="h-full-width h-remove-bottom" name="courses" id="cMinistry">
                                    <option value="Pastor">Pastor</option>
                                    <option value="Apostelship">Apostelship</option>
                                    <option value="Prayer Team">Prayer Team</option>
                                    <option value="Administrative Support">Administrative Support</option>
                                    <option value="Production Design">Production Design</option>
                                    <option value="Technical & Stage Management">Technical & Stage Management</option>
                        ...
                        <div class="form-field">
                            ...
                            <div class="ss-custom-select">
                                <select class="h-full-width h-remove-bottom" name="duration" id="cDuration">
                        ...
                        <div class="comments form-field">
                            <textarea name="questions" id="cQuestions" class="h-full-width h-remove-bottom" placeholder="Comments & Questions"></textarea>
                        </div>

                        <br>

                        <input name="daat" id="submit" class="btn btn--primary btn--large h-full-width" 
                        value="Submit Form" type="submit" onclick = "reloadStop()">
    ...
    <script>
         function reloadStop(){
               ...
               var ministry = document.getElementById("cMinistry").value;
               var duration = document.getElementById("cDuration").value;
               var question = document.getElementById("cQuestions").value;

               if (name == "" || email == "" || phone == "" || ministry == "" || duration == "" || question == "") {
