...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>HASED CHRISTAIN CENTER - Contact</title>
            ...
            <div class="column">
                ...
                <form  id="contactForm" method="post" action="" autocomplete="off">
                    <fieldset>
                        ...
                        <div class="form-field">
                            <input name="phone" id="cPhone" class="h-full-width h-remove-bottom" placeholder="Phone Number" type="number">
                        </div>

                        <div class="message form-field">
                            <textarea name="message" id="cMessage" class="h-full-width h-remove-bottom" placeholder="Your Message"></textarea>
                        </div>
                        <br>
                        <input name="submit" id="submit" class="btn btn--primary btn-wide btn--large h-full-width" 
                        value="Send Message" type="submit" onclick = "reloadStop()">
